...
const Home = () => {
    ...
    return (
        <Container>
            <Box display={{ md: 'flex' }}>
            <Head>
                    <title>Aglez Dev - Posts </title>
                    <meta name="description" content="All my published posts about coding, tech and learning." />
                    <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                    <meta name="twitter:title" content="AglezDev" />
                    <meta property="og:title" content="AglezDev" />
                    <meta property="og:image" content="/og.png" />
                    <meta property="og:description" content="All my published posts about coding, tech and learning." />
